...
import com.angeleo.sks.core.util.CharUtil;
import com.angeleo.sks.core.util.JacksonUtil;
import com.angeleo.sks.core.util.RegexUtil;
...
import com.angeleo.sks.db.service.CouponAssignService;
...
import com.angeleo.sks.wx.dto.WxLoginInfo;
import com.angeleo.sks.wx.service.CaptchaCodeManager;
import com.angeleo.sks.wx.service.UserTokenManager;
...
public class WxAuthController {
    ...
    public Object login(@RequestBody String body, HttpServletRequest request) {
        ...
        List<SksUser> userList = userService.queryByUsername(username);
        SksUser user = null;
        if (userList.size() > 1) {
    ...
    public Object loginByWeixin(@RequestBody WxLoginInfo wxLoginInfo, HttpServletRequest request) {
        ...
        SksUser user = userService.queryByOid(openId);
        if (user == null) {
            user = new SksUser();
    ...
    public Object register(@RequestBody String body, HttpServletRequest request) {
        ...
        if(!StringUtils.isEmpty(wxCode)) {
            ...
            if (userList.size() == 1) {
                SksUser checkUser = userList.get(0);
    ...
    public Object reset(@RequestBody String body, HttpServletRequest request) {
        ...
        List<SksUser> userList = userService.queryByMobile(mobile);
        SksUser user = null;
        if (userList.size() > 1) {
            return ResponseUtil.serious();
        } else if (userList.size() == 0) {
