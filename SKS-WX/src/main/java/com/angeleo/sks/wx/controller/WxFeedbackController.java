...
import com.angeleo.sks.db.service.SksFeedbackService;
...
public class WxFeedbackController {
    ...
    @Autowired
    private SksFeedbackService feedbackService;
    @Autowired
    private SksUserService userService;

    private Object validate(SksFeedback feedback) {
     ...
     */
    @PostMapping("submit")
    public Object submit(@LoginUser Integer userId, @RequestBody SksFeedback feedback) {
        if (userId == null) {
