...
// 云平台上线时使用
// var WxApiRoot = 'https://angeleo.top/wx/';
...
module.exports = {
  ...
  SnapUpList: WxApiRoot + 'snapup/list', //团购列表
  SnapUpMy: WxApiRoot + 'snapup/my', //团购API-我的团购
  SnapUpDetail: WxApiRoot + 'snapup/detail', //团购API-详情
  SnapUpJoin: WxApiRoot + 'snapup/join', //团购API-详情
