...
import com.angeleo.sks.admin.service.LogHelper;
...
import com.angeleo.sks.db.service.SksAftersaleService;
...
import com.angeleo.sks.db.util.AftersaleConstant;
...
public class AdminAftersaleController {
    ...
    @Autowired
    private SksGoodsProductService goodsProductService;
    @Autowired
    ...
    public Object list(Integer orderId, String aftersaleSn, Short status,
        ...
        List<SksAftersale> aftersaleList = aftersaleService.querySelective(orderId, aftersaleSn, status, page, limit, sort, order);
    ...
    @PostMapping("/recept")
    public Object recept(@RequestBody SksAftersale aftersale) {
        Integer id = aftersale.getId();
        SksAftersale aftersaleOne = aftersaleService.findById(id);
    ...
    public Object batchRecept(@RequestBody String body) {
        ...
        assert ids != null;
        for(Integer id : ids) {
            SksAftersale aftersale = aftersaleService.findById(id);
            if(aftersale == null){
                continue;
            }
    ...
    @PostMapping("/reject")
    public Object reject(@RequestBody SksAftersale aftersale) {
        Integer id = aftersale.getId();
        SksAftersale aftersaleOne = aftersaleService.findById(id);
        if(aftersaleOne == null){
    ...
    @PostMapping("/refund")
    public Object refund(@RequestBody SksAftersale aftersale) {
        Integer id = aftersale.getId();
        SksAftersale aftersaleOne = aftersaleService.findById(id);
        if(aftersaleOne == null){
            return ResponseUtil.badArgumentValue();
        ...
        SksOrder order = orderService.findById(orderId);
