...
public class AdminAdminController {
    ...
    public Object list(String username,
        ...
        List<SksAdmin> adminList = adminService.querySelective(username, page, limit, sort, order);
        return ResponseUtil.okList(adminList);
    }

    private Object validate(SksAdmin admin) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody SksAdmin admin) {
    ...
    public Object read(@NotNull Integer id) {
        SksAdmin admin = adminService.findById(id);
        return ResponseUtil.ok(admin);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody SksAdmin admin) {
        Object error = validate(admin);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody SksAdmin admin) {
        Integer anotherAdminId = admin.getId();
        if (anotherAdminId == null) {
            return ResponseUtil.badArgument();
        }
        ...
        SksAdmin currentAdmin = (SksAdmin) currentUser.getPrincipal();
