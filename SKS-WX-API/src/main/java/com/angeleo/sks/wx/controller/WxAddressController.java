...
import com.angeleo.sks.db.service.SksAddressService;
import com.angeleo.sks.db.service.SksRegionService;
import com.angeleo.sks.wx.annotation.LoginUser;
import com.angeleo.sks.wx.service.GetRegionService;
...
public class WxAddressController extends GetRegionService {
	...
	public Object list(@LoginUser Integer userId) {
		...
		List<SksAddress> addressList = addressService.queryByUid(userId);
	...
	public Object detail(@LoginUser Integer userId, @NotNull Integer id) {
		...
		SksAddress address = addressService.query(userId, id);
		if (address == null) {
	...
	private Object validate(SksAddress address) {
	 ...
	 */
	@PostMapping("save")
	public Object save(@LoginUser Integer userId, @RequestBody SksAddress address) {
		if (userId == null) {
			return ResponseUtil.unlogin();
		}
	 ...
	 */
	@PostMapping("delete")
	public Object delete(@LoginUser Integer userId, @RequestBody SksAddress address) {
		if (userId == null) {
			return ResponseUtil.unlogin();
		}
