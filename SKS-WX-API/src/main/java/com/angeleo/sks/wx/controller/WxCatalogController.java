...
import com.angeleo.sks.wx.service.HomeCacheManager;
...
public class WxCatalogController {
    ...
    public Object getSecondCategory(@NotNull Integer id) {
        // 所有二级分类目录
        List<SksCategory> currentSubCategory = categoryService.queryByPid(id);
    ...
    public Object index(Integer id) {
        ...
        // 当前一级分类目录
        SksCategory currentCategory = null;
        if (id != null) {
        ...
        // 当前一级分类目录对应的二级分类目录
        List<SksCategory> currentSubCategory = null;
    ...
    public Object queryAll() {
        ...
        //所有子分类列表
        Map<Integer, List<SksCategory>> allList = new HashMap<>();
        List<SksCategory> sub;
        ...
        // 当前一级分类目录
        SksCategory currentCategory = l1CatList.get(0);
    ...
    public Object current(@NotNull Integer id) {
        // 当前分类
        SksCategory currentCategory = categoryService.findById(id);
        if(currentCategory == null){
            return ResponseUtil.badArgumentValue();
        }
        List<SksCategory> currentSubCategory = categoryService.queryByPid(currentCategory.getId());
