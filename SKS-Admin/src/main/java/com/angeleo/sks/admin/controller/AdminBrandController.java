...
import com.angeleo.sks.db.service.SksBrandService;
...
public class AdminBrandController {
    ...
    public Object list(String id, String name,
        ...
        List<SksBrand> brandList = brandService.querySelective(id, name, page, limit, sort, order);
        return ResponseUtil.okList(brandList);
    }

    private Object validate(SksBrand brand) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody SksBrand brand) {
    ...
    public Object read(@NotNull Integer id) {
        SksBrand brand = brandService.findById(id);
        return ResponseUtil.ok(brand);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody SksBrand brand) {
        Object error = validate(brand);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody SksBrand brand) {
