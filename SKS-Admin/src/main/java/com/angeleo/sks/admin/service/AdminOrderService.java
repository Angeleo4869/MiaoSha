...
public class AdminOrderService {
    ...
    public Object list(Integer userId, String orderSn, LocalDateTime start, LocalDateTime end, List<Short> orderStatusArray,
        ...
        List<SksOrder> orderList = orderService.querySelective(userId, orderSn, start, end, orderStatusArray, page, limit,
                sort, order);
        return ResponseUtil.okList(orderList);
    }

    public Object detail(Integer id) {
        SksOrder order = orderService.findById(id);
        List<SksOrderGoods> orderGoods = orderGoodsService.queryByOid(id);
    ...
    public Object reply(String body) {
        ...
        // 目前只支持回复一次
        SksComment comment = commentService.findById(commentId);
        if(comment == null){
            return ResponseUtil.badArgument();
        }
