...
import com.angeleo.sks.admin.util.Permission;
import com.angeleo.sks.admin.util.PermissionUtil;
import com.angeleo.sks.admin.vo.PermVo;
...
import com.angeleo.sks.db.service.SksPermissionService;
import com.angeleo.sks.db.service.SksRoleService;
...
public class AdminRoleController {
    ...
    @Autowired
    private SksRoleService roleService;
    @Autowired
    private SksPermissionService permissionService;
    @Autowired
    ...
    public Object list(String name,
        ...
        List<SksRole> roleList = roleService.querySelective(name, page, limit, sort, order);
        return ResponseUtil.okList(roleList);
    }

    @GetMapping("/options")
    public Object options() {
        List<SksRole> roleList = roleService.queryAll();
    ...
    public Object read(@NotNull Integer id) {
        SksRole role = roleService.findById(id);
        return ResponseUtil.ok(role);
    }


    private Object validate(SksRole role) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody SksRole role) {
    ...
    @PostMapping("/update")
    public Object update(@RequestBody SksRole role) {
        Object error = validate(role);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody SksRole role) {
    ...
    private List<PermVo> getSystemPermissions() {
        final String basicPackage = "com.angeleo.sks.admin";
    ...
    public Object updatePermissions(@RequestBody String body) {
        ...
        for (String permission : permissions) {
            SksPermission sksPermission = new SksPermission();
            sksPermission.setRoleId(roleId);
            sksPermission.setPermission(permission);
            permissionService.add(sksPermission);
        }
        return ResponseUtil.ok();
    }
