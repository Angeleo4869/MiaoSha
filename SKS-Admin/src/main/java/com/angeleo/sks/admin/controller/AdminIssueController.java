...
import com.angeleo.sks.db.service.SksIssueService;
...
public class AdminIssueController {
    ...
    @Autowired
    private SksIssueService issueService;
    ...
    public Object list(String question,
        ...
        List<SksIssue> issueList = issueService.querySelective(question, page, limit, sort, order);
        return ResponseUtil.okList(issueList);
    }

    private Object validate(SksIssue issue) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody SksIssue issue) {
    ...
    public Object read(@NotNull Integer id) {
        SksIssue issue = issueService.findById(id);
        return ResponseUtil.ok(issue);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody SksIssue issue) {
        Object error = validate(issue);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody SksIssue issue) {
